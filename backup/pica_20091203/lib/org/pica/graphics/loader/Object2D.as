package org.pica.graphics.loader {
	...
	public class Object2D extends Bitmap {
		...
		public function load(src:*, dw:uint, dh:uint, key_color:int, onloaded:Function, filter:BitmapFilter=null, mask:BitmapData=null):void {
			data_ = new Array();
		...
		public function get currentFrameIdx():uint {
			return curr_frame_;
		}
		
		public function get currentFrame():BitmapData {
			return data_[curr_frame_];
		}
		
		public function getAnimation(name:String):Object {
			return frames_[name];
		}
		
		public function get currAnimation():Object {
			return curr_animation_;
		}
		
		public function getFrame(idx:uint):BitmapData {
			return data_[idx];
		}
		...
		private function postprocessing(bd:BitmapData):void {
			...
			trans_data.threshold(bd, rec, tl, "==", key_color_, 0x00000000, 0xFFFFFFFF, true);			
