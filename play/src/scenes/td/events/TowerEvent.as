package scenes.td.events {
	...
	public class TowerEvent extends Event {
		...
		static public const TOWER_OPTION:String		= "topt";
		static public const TOWER_LOAD:String		= "load";
		static public const TOWER_GEM:String		= "sgem";	// select gem
		static public const TOWER_COST:String		= "cost";
