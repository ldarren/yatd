package {
	...
	public class Editor extends UIComponent {
		...
		private var mPHP_:ExternalLoader;
		private var hostId_:String = "533769089";
		...
		public function Editor() {
			...
			mPHP_ = new ExternalLoader("http://ldarren.g0dsoft.com/yatd");
		}
		...
		public function init(toolbar:ApplicationControlBar):void {
			...
			mPHP_.dispatcher.addEventListener(NetEvent.RECEIVED, populate);
		}
		...
		private function openFile():void {
			mPHP_.request({action:"load", id:hostId_} );
			trace("Reading file from file server...");
		}
		
		private function populate(evt:NetEvent):void {
...
trace("i: " + node.index + " char: " + parseInt(data.charAt(i)));
		...
		private function saveFile():void {
			mPHP_.submit( { id:hostId_, action:"save", map:mGrid_.serialize() } );
