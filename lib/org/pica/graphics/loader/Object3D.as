package org.pica.graphics.loader {
	...
	public class Object3D extends DisplayObject3D {
		...
		public function openModel(name:String, path:String, fname:String, tex:Bitmap, onloaded:Function):void {
			...
			case "md2":
				model = new MD2(true);
				MD2(model).load(path + fname, new BitmapMaterial(tex.bitmapData));
				break;
			}
			if (onloaded != null) {
